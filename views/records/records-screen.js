...
export default class RecordsScreen extends React.Component {
    ...
    _handleRecordSelect(element) {
        this.props.navigation.navigate('RecordDetails', { record: element });
    }
        ...
        if (index % 20 == 0) {
            return (
                <View>
                    ...
                    <RecordComponent _handleAddNewRecord={this._handleAddNewRecord} _handleDeleteRecord={this._handleDeleteRecord} _handleRecordSelect={this._handleRecordSelect} key={index} record={item} />
                </View>
            )
        }
        return (<RecordComponent _handleAddNewRecord={this._handleAddNewRecord} _handleDeleteRecord={this._handleDeleteRecord} _handleRecordSelect={this._handleRecordSelect} key={index} record={item} />)
    }
